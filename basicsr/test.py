...
def main():
    ...
    input_names = ['input']
    output_names = ['output']
    torch.onnx.export(model.net_g.module, dummy_input, "trt_onnx/edvr.onnx", verbose=True, opset_version=11, 
...
#/usr/local/tensorrt7/bin/trtexec --onnx=edvr.onnx --saveEngine=edvr.trt --optShapes=input:1x7x3x144x176 --verbose