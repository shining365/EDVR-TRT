...
class ModulatedDeformConvFunction(Function):
    ...
    @staticmethod
    def symbolic(g, input_data, offset, mask, weight, bias, stride, padding, dilation, groups, deformable_groups):
        return g.op('ModulatedDeformConvFunction', input_data, weight, bias, offset, mask)
