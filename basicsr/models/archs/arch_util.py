...
register_custom_op_symbolic('my::ModulatedDeformConvFunction', my_modulated_deform_conv, 11)
...
class DCNv2Pack(ModulatedDeformConvPack):
    ...
    def forward(self, x, feat):
        ...
        # torch.ops.my.DeformConvFunction(x, offset, mask, self.weight, self.bias,
        #                              self.stride, self.padding, self.dilation,
        #                              self.groups, self.deformable_groups)