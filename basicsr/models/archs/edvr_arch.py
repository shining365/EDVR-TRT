...
class TSAFusion(nn.Module):
    ...
    def forward(self, aligned_feat):
        ...
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/feat1', feat.cpu())

        # spatial attention
        attn = self.lrelu(self.spatial_attn1(aligned_feat))
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn0', attn.cpu())
        attn_max = self.max_pool(attn)
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn_max', attn_max.cpu())
        attn_avg = self.avg_pool(attn)
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn_avg', attn_avg.cpu())
        attn = self.lrelu(
            self.spatial_attn2(torch.cat([attn_max, attn_avg], dim=1)))
        
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn1', attn.cpu())
        ...
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn_level1', attn_level.cpu())
        
        attn_level = self.lrelu(self.spatial_attn_l3(attn_level))
        attn_level = self.upsample(attn_level)

        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn_level2', attn_level.cpu())
        ...
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn2', attn.cpu())
        
        attn_add = self.spatial_attn_add2(
            self.lrelu(self.spatial_attn_add1(attn)))
        attn = torch.sigmoid(attn)

        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/attn3', attn.cpu())

        # after initialization, * 2 makes (attn * 2) to be close to 1.
        feat = feat * attn * 2 + attn_add
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/feat', feat.cpu())
        return feat
...
class EDVR(nn.Module):
    ...
    def forward(self, x):
        ...
        #np.save('/home/gji/gji/workspace/TRTSamples/PyTrtLite/aligned_feat', aligned_feat.cpu())
